 ...
 * @access public
 */
class Orchid_Store_Breadcrumb_Trail {
	...
	protected function set_labels() {
		...
		$defaults = array(
			'browse'              => esc_html__( 'Browse:',                               'orchid-store' ),
			'aria_label'          => esc_attr_x( 'Breadcrumbs', 'breadcrumbs aria label', 'orchid-store' ),
			'home'                => esc_html__( 'Home',                                  'orchid-store' ),
			'error_404'           => esc_html__( '404 Not Found',                         'orchid-store' ),
			'archives'            => esc_html__( 'Archives',                              'orchid-store' ),
			// Translators: %s is the search query.
			'search'              => esc_html__( 'Search results for: %s',                'orchid-store' ),
			// Translators: %s is the page number.
			'paged'               => esc_html__( 'Page %s',                               'orchid-store' ),
			// Translators: %s is the page number.
			'paged_comments'      => esc_html__( 'Comment Page %s',                       'orchid-store' ),
			// Translators: Minute archive title. %s is the minute time format.
			'archive_minute'      => esc_html__( 'Minute %s',                             'orchid-store' ),
			// Translators: Weekly archive title. %s is the week date format.
			'archive_week'        => esc_html__( 'Week %s',                               'orchid-store' ),
