...
function themefarmer_companion_admin_footer_icons_html(){
	...
	<div class="themefarmer-basic-icon-panel-overlay" style="display: none;">
		<div class="themefarmer-basic-icon-panel">
			<button type="button" class="media-modal-close"><span class="media-modal-icon">x<span class="screen-reader-text"><?php esc_html_e('Close media panel', 'themefarmer-companion'); ?></span></span></button>
